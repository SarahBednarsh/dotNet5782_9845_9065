...
namespace PL
{
    public class Drone : DependencyObject
    {
        ...
        static readonly DependencyProperty DroneParcelIdPropery = DependencyProperty.Register("DroneParcelId", typeof(string), typeof(Drone));
        ...
        public string DroneParcelId { get => (string)GetValue(DroneParcelIdPropery); set => SetValue(DroneParcelIdPropery, value); }
